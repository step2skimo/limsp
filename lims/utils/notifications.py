...
def notify_client_on_coa_release(client, samples, summary_text, parameters):
    ...
    coa_html = render_to_string("lims/coa_template.html", {
        "client": client, "samples": samples, "summary_text": summary_text,
        "parameters": parameters, "today": datetime.date.today(),
    ...
    msg = EmailMultiAlternatives(
        subject, text_body, settings.DEFAULT_FROM_EMAIL, [client.email],
